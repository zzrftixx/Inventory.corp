...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mt-6">
    <div class="p-6 border-b border-slate-100">
        ...
        <p class="text-sm text-slate-500">Masukkan detail kategori barang untuk referensi material</p>
    </div>
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="p-6 space-y-6">
        ...
        <div class="flex justify-end pt-4 border-t border-slate-100 space-x-3">
            ...
            <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-primary hover:bg-sky-600 rounded-lg transition-colors shadow-sm">Simpan Kategori</button>
        </div>
    </form>
</div>
@endsection
