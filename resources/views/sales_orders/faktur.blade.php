...
<body class="p-8 max-w-4xl mx-auto">
        ...
        <div class="w-1/2 md:w-1/3">
            <table class="w-full text-sm">
                <tr class="border-t-2 border-gray-800 text-lg">
                    ...
                    <td class="text-right py-2 font-black text-[#0ea5e9] tracking-wider font-mono">Rp
                        {{ number_format($sales_order->total_invoice, 0, ',', '.') }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="flex justify-between items-end border-t border-gray-200 mt-16 pt-6">
        ...
        <div class="text-center">
            ...
            <p class="font-bold underline text-gray-800">{{ $sales_order->user->name ?? 'Finance Manager' }}</p>
