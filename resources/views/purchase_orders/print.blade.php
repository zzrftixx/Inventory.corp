...
<body
    class="p-8 max-w-4xl mx-auto border border-gray-200 min-h-screen my-4 shadow-sm print:border-none print:shadow-none print:my-0">
    ...
    <div class="flex justify-between items-start border-b-2 border-gray-800 pb-6 mb-8 mt-4">
        <div>
            ...
            <div class="mt-4 text-sm text-gray-600">
                <p>Jl. Karang Tengah Sitimulyo, Karang Anom, Sitimulyo, Kec. Piyungan, Kabupaten Bantul, Daerah Istimewa
                    Yogyakarta 55792</p>
        ...
        <div class="text-right">
            ...
            <div class="mt-4 grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-left">
                ...
                <div class="font-bold text-gray-900">
                    {{ \Carbon\Carbon::parse($purchaseOrder->tanggal_po)->format('d F Y') }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-10 p-4 border border-gray-300 rounded bg-gray-50 w-1/2">
        <p class="text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 border-b border-gray-300 pb-2">Kepada
            (Vendor/Supplier):</p>
        <p class="text-lg font-black text-gray-800">{{ $purchaseOrder->supplier->nama_supplier ?? 'Unknown Supplier' }}
        </p>
        <p class="text-sm mt-1 text-gray-600 whitespace-pre-line">Kontak / Tlp:
            {{ $purchaseOrder->supplier->kontak ?? '-' }}</p>
    </div>

    <p class="mb-4 text-sm font-medium">Mohon dikirimkan barang-barang di bawah ini sesuai dengan pesanan yang tertera:
    </p>
    ...
    <div class="mb-12">
        ...
        <ul class="text-sm list-disc pl-5 text-gray-700 space-y-1">
            <li>Mohon lampirkan Salinan Purchase Order ini bersama dengan Faktur/Surat Jalan saat pengiriman barang.
            </li>
    ...
    <div class="flex justify-between items-end mt-16 text-center">
        ...
        <div class="w-1/3">
            ...
            <p class="font-bold underline text-gray-800">{{ $purchaseOrder->user->name ?? 'CV MA KARYA Artha Graha' }}
            </p>
